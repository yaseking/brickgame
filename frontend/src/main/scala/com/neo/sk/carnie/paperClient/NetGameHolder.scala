...
//  var totalData: scala.Option[Protocol.Data4TotalSync] = None
  ...
  private[this] val bgm = dom.document.getElementById("V.A. - びっくり熱血新記録!はるかなる金メダル：：テクノスロゴ~デモ").asInstanceOf[HTMLAudioElement]
  ...
  private[this] var BGM = dom.document.getElementById("V.A. - びっくり熱血新記録!はるかなる金メダル：：テクノスロゴ~デモ").asInstanceOf[HTMLAudioElement]
